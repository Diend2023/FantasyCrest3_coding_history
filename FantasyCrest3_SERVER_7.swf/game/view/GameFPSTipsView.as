package game.view
{
   ...
   public class GameFPSTipsView extends DisplayObjectContainer
   {
      ...
      override public function onInit() : void
      {
         ...
         { //
            text.text = "幻想纹章3本地版0.4更新内容：\n\n1、添加角色：布罗利「TYRANNICAL」(纹4)(未完成)、贝吉塔、孙悟空·超级赛亚人\n\n2、添加npc：道士、翘曲传送门\n\n3、修复角色：布罗利「TYRANNICAL」(纹4) 立绘、布罗利「TYRANNICAL」(纹4) 头像、贝吉塔 立绘、贝吉塔 头像、孙悟空·超级赛亚人 立绘、孙悟空·超级赛亚人 头像、优子 立绘、优子 头像、猪人 头像、白金 立绘、赛莉卡 立绘、天之咒印·佐助 立绘、夏目麻衣 立绘、破坏神·须佐之男 立绘、琥珀响 立绘、乔瑟夫·乔斯达 立绘、pop子 立绘、pop子 头像、大魔导师-奈茵 立绘、哈扎吗 立绘、Yang Xiaolong 立绘、Ruby 立绘\n\n4、添加副本：syzlb（未命名，现征集副本名称）\n\n5、添加功能：导出存档(主菜单右上角按钮)，导入存档(登录界面注册按钮)\n\n6、修复问题：pvp战绩败局不记录\n\n7、角色调整：增强如月琴恩伤害至0.65\n\n"; //
         }); //
      }
   }
}
