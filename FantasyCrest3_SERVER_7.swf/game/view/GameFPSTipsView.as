package game.view
{
   ...
   public class GameFPSTipsView extends DisplayObjectContainer
   {
      ...
      override public function onInit() : void
      {
         ...
         { //
            text.text = "幻想纹章3本地版0.7更新内容：\n\n1、修复角色：布罗利「TYRANNICAL」(纹4) 部分抓取，汤姆 被动，鸟魂.麻将人 被动，拉格纳 被动\n\n2、调整角色：空条承太郎 物理伤害由1调整至0.8，疾风传佐助 大小由0.7调整至0.6，疾风传佐助 技能消耗增加，疾风传佐助 技能CD增加\n\n3、添加功能：游戏排行榜，设置功能（目前仅有开启全屏选项）\n\n4、修复问题：修复错误的存档数据结构，修复PVP疾风传佐助麒麟CD的问题"; //
         }); //
      }
   }
}
