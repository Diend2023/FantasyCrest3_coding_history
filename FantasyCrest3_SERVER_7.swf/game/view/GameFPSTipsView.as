package game.view
{
   ...
   public class GameFPSTipsView extends DisplayObjectContainer
   {
      ...
      override public function onInit() : void
      {
         ...
         { //
            text.text = "幻想纹章3本地版0.8更新内容：\n\n1、修复角色：布罗利「TYRANNICAL」(纹4) ，空我 被动，白金 被动，李洛克 被动，天之咒印·佐助 被动，如月琴恩（旧） I技能\n\n2、添加功能：声音开关，BGM开关，入场动作效果\n\n3、修复问题：修复技能音效播放不完整，画面缩放方式不正确，冰冻特效（新、旧琴恩，冬狮郎）在死亡时报错，纹4布罗利多个bug"; //
         }); //
      }
   }
}
